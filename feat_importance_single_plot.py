...
def plot_feature_importance(
    ...
    axes.set(title=title, xlabel='Feature', ylabel='Importance')
...
coeff_fig, coeff_ax = plt.subplots(2, 4, figsize=(70, 30))
permut_fig, permut_ax = plt.subplots(2, 4, figsize=(70, 30))
...
coeff_fig.savefig(SAVE_DIR / 'feature_importance_coeff_test.png')
permut_fig.savefig(SAVE_DIR / 'feature_importance_permut_test.png')
